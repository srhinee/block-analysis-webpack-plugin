...
const {originHandel, optimizeHandel,emitHandel} = require ('./webpack4Handler.js')
    ...
    apply (compiler) {
      compiler.hooks.compilation.tap (PLUGIN_NAME, (compilation, callback) => {
        ...
        if (!compilation.compiler.parentCompilation) {
          compilation.hooks.seal.tap (PLUGIN_NAME, () => originHandel (compilation))

          compilation.hooks.beforeModuleAssets.tap (PLUGIN_NAME, () => optimizeHandel (compilation))
